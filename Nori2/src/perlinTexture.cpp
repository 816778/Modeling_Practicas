...
public:
    ...
    Perlin(const PropertyList &propList) {
        m_width = propList.getInteger("width", 1280);
        m_height = propList.getInteger("height", 720);
        m_levels = propList.getInteger("levels", 5);
        //primeIndex = 0;
...
NORI_REGISTER_CLASS(Perlin, "perlintexture")
NORI_NAMESPACE_END
